...
public class OpenCartProductDetailPage extends AbstractPage {
	...
	public OpenCartProductDetailPage addProductToTheCart(String prodPrice) {
		...
		Assert.assertEquals(Prodprice, prodPrice);
	 ...
	 * @return
	 */
	public OpenCartProductDetailPage addProductUpdateQtyAndVerifyQtyInCart(
			Product product) {
		...
		WaitForElements.waitForElementClickable(driver, 20, txtProductQuantity);
		btnUpdateCart.click();
		// Assert.assertEquals(getAttributeValue(txtProductQuantity,"value"),
